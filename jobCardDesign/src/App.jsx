    ...
    <div className='parent'>
      {
        jobOpenings.map(function (elem, idx) {
          return <div key={idx}>
            <Cards companyName= {elem.companyName} brandLogo={elem.brandLogo} tag2={elem.tag2} tag1= {elem.tag1} post={elem.post} pay={elem.pay} location={elem.location}  datePosted={elem.datePosted} />
          </div>
        })}
